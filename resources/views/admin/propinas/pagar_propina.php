                    ...
                    <div class="inner-item dash-search-form">
                        <form action="/pesquisar_pagamento_estudante" method="POST">
                            ...
                            <div class="col-sm-4">
                                ...
                                <select name="estudante_id" id="estudante_id">
                                    <option>--Selecione--</option>
                                </select>
                            </div>
                            <div class="col-sm-2">
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title"><i class="fa fa-edit"></i>Editar pagamento</h4>
                                            </div>
                                            <div class="modal-body dash-form">
                                                <form action="{{route('actualizar_pagamento', ['id'=>$pagamento->id])}}"
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <input type="text" value="{{ session('curso')->propina->Valor}}"
                                                            disabled />
                                                    </div>
                                                    <div class="col-sm-3">
                                                    ...
                                                    <div class="col-sm-3">
                                                        ...
                                                        <select name="tpagamento_id" id="tpagamento_id">
                                                            ...
                                                            <option value="{{$tpagamento->id}}">{{$tpagamento->nome}}
                                                            </option>
                                                            @endforeach
                                                        </select>
                                                    </div>
